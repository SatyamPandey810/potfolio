...
export function Planet(props) {
  ...
  // Scale based on viewport width — tune these values to your scene
  const scale = Math.max(0.4, Math.min(1, viewport.width / 2));
  ...
  return (
    <group ref={shapeContainer} {...props} scale={scale} dispose={null}>
